...
unsigned int bq24261_read_byte(unsigned char cmd, unsigned char *returnData)
{
    char     cmd_buf[1]={0x00};
    char     readData = 0;
    int      ret=0;
...
unsigned int bq24261_write_byte(unsigned char cmd, unsigned char writeData)
{
    char    write_data[2] = {0};
    int     ret=0;
...
#else
unsigned int bq22161_read_byte(unsigned char cmd, unsigned char *returnData)
{
...
/**********************************************************
  ...
  *
  *********************************************************/
unsigned int bq24261_read_interface(unsigned char RegNum, unsigned char *val, unsigned char MASK,
				  unsigned char SHIFT)
{
...
{
    unsigned int ret=0;    
	battery_log(BAT_LOG_FULL,"[%s %d]val = 0x%x\n",__FUNCTION__,__LINE__,val);
...
{
    unsigned char i=0;
    battery_log(BAT_LOG_FULL,"[bq24261_dump_register] ");
...
#ifdef CONFIG_OF
	battery_log(BAT_LOG_CRTI, "[bq24261_init] init start with i2c DTS");
#else
